...
namespace Otz.Mathematics
{
    public static class MathUtility
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static quaternion GetLocalRotationForWorldRotation(quaternion parentLTWRotation, quaternion targetWorldRotation)
        {
            return math.mul(math.inverse(parentLTWRotation), targetWorldRotation);
        }
